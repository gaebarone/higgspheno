...
double get_cross_section(const char *process_name) {
  ...
  std::string zzhqq = "z0z0hqq";
  std::string zzhqq = "z0zThqq";
  std::string zzhqq = "zTzThqq";
  ...
  else if (process_name == zzhqq) return 0.000000204;     // 2.04e-07
  else if (process_name == z0z0hqq) return 0.00000002221; // 2.221e-08
  else if (process_name == z0zThqq) return 0.0000000956;  // 9.56e-08
  else if (process_name == zTzThqq) return 0.00000008732; // 8.732e-08
  else return 1.0;
}
#endif
