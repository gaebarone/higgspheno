...
loopsm_directory = '/isilon/data/users/sellis9/mg_conda/MG5_aMC_v3_5_2/EVENTS/vvhjj/loopsm/'
hhvbf_directory = '/isilon/data/users/sellis9/mg_conda/MG5_aMC_v3_5_2/EVENTS/vvhjj/hhvbf/'
...
with open(output_file, 'w') as output:
    ...
    output.write(f"  std::string DY2j3j = \"DY2j3j\"; \n")
    ...
    output.write(f"  if (process_name == DY2j3j) return 151.2; \n") 
