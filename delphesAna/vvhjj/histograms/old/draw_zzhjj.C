...
void draw_zzhjj_(string sig_filename = "../outputs/wpwmhqq.root", string bkg_filename = "../outputs/all_bkg.root",string ttbar_filename = "../outputs/ttbar.root", string ttHbb_filename = "../outputs/ttHbb.root", string diboson_filename = "../outputs/diboson.root", string drellyan_filename = "../outputs/drellyan.root", string outputFolder = ".") {
...
void draw_zzhjj(string sel=""){
  ...
  selMapToHistsSignal["HWWJJ"] = "../outputs/wpwmhqq.root";
  selMapToHistsSignal["HZZJJ"] = "../outputs/zzhqq.root";

  system(Form("mkdir -p ../histograms/%s/stacks",sel.c_str()));

  draw_zzhjj_(selMapToHistsSignal[sel],
	     Form("../outputs/all_bkg.root",sel.c_str()),
	     Form("../outputs/ttbar.root",sel.c_str()),
	     Form("../outputs/ttHbb.root",sel.c_str()),
	     Form("../outputs/diboson.root",sel.c_str()),
	     Form("../outputs/drellyan.root",sel.c_str()),
	     Form(".",sel.c_str()));
