...
=======
  ...
  else if (process_name == w+0w-0hqq) return 0.0000011600; 
  else if (process_name == w+0w-0qq) return 0.0009249840; 
  else if (process_name == w+0w-Thqq) return 0.0000025706; 
  else if (process_name == w+0w-Tqq) return 0.0028489600; 
  else if (process_name == w+Tw-0hqq) return 0.0000027306; 
  else if (process_name == w+Tw-0qq) return 0.0030484800; 
  else if (process_name == w+Tw-Thqq) return 0.0000062106; 
  else if (process_name == w+Tw-Tqq) return 0.0101523200; 
  else if (process_name == w+w-hqq) return 0.0000126695; 
  else if (process_name == w+w-qq) return 0.0169777600; 
