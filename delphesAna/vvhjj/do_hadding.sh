...
hadd /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/diboson_${selection}.root /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/${selection}_wwjj_j.root /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/${selection}_wzjj_j.root /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/${selection}_wz_wjj_123j.root /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/${selection}_zzjj_j.root /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/${selection}_zz_zjj_123j.root
...
hadd all_bkg_${selection}.root ttbar_${selection}.root ttHbb_${selection}.root diboson_${selection}.root drellyan_${selection}.root
