...
hadd /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/wpwmhqq_${selection}.root wpwmhqq/${selection}_del*.root
#hadd /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/wp0wm0hqq_${selection}.root wp0wm0hqq/${selection}_del*.root
#hadd /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/wp0wmThqq_${selection}.root wp0wmThqq/${selection}_del*.root
#hadd /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/wpTwm0hqq_${selection}.root wpTwm0hqq/${selection}_del*.root
#hadd /isilon/data/users/sellis9/higgsandmore/delphesAna/vvhjj/rootOutputs/wpTwmThqq_${selection}.root wpTwmThqq/${selection}_del*.root
